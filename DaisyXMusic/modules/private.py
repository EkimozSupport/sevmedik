    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "Combot News", url=f"https://t.me/{UPDATES_CHANNEL}"), 
                    InlineKeyboardButton(
                        "Combot Türkiye grup", url=f"https://t.me/{SUPPORT_GROUP}")
                ],[
                    InlineKeyboardButton(
                        "Combot World party", url=f"https://{SOURCE_CODE}")
                ]
            ]
        ),
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**🙋‍♀️ Merhaba oradaki! Telegram gruplarının ve kanallarını koruyabilirim.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
